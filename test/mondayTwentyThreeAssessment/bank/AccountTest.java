...
public class AccountTest {
    ...
    public void newAccount_balanceIsEmptyTest() {
        assertEquals(BigDecimal.ZERO, account.checkBalance(pin, name));
    }
    ...
    public void deposit5kIntoNewAccount_balanceIs5kTest() {
        ...
        assertEquals(BigDecimal.valueOf(5_000), account.checkBalance(pin, name));
    }
    ...
    public void deposit5kTwiceIntoNewAccount_balanceIs10kTest() {
        ...
        account.deposit(BigDecimal.valueOf(5_000));
        account.deposit(BigDecimal.valueOf(5_000));
        assertEquals(BigDecimal.valueOf(10_000), account.checkBalance(pin, name));
    }
    ...
    public void deposit5k_withdraw2k_balanceIs3k_balanceIs10kTest() {
        ...
        assertEquals(BigDecimal.valueOf(3_000), account.checkBalance(pin, name));
    }
